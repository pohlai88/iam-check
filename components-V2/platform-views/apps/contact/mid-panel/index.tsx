...
import LeftPanel from '@/components-V2/platform-views/apps/contact/left-panel'
...
import { getVisibleContacts, groupContactsByLetter, sortContacts, type ContactFilter } from '@/components-V2/platform-utils/contact-utils'
