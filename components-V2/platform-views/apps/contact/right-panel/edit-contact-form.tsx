...
// Type imports
import type { Contact, Label as ContactLabel, CreateContactInput } from '@/components-V2/platform-types/apps/contact-types'
...
import {
  ...
  validateEmail,
  validatePhoneNumber
} from '@/components-V2/platform-utils/contact-utils'
