...
// Type imports
import type { ContactNavItem, Label } from '@/components-V2/platform-types/apps/contact-types'
import { CONTACT_LABELS, CONTACT_LABEL_STYLES } from '@/components-V2/platform-types/apps/contact-types'
