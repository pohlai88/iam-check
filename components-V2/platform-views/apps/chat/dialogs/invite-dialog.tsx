...
// Type Imports
import type { ChatUser } from '@/components-V2/platform-types/apps/chat-types'

// Component Imports
import { Avatar, AvatarFallback, AvatarImage } from '@/components-V2/platform-components/ui/avatar'
import { Button } from '@/components-V2/platform-components/ui/button'
import { Dialog, DialogContent, DialogHeader, DialogTitle } from '@/components-V2/platform-components/ui/dialog'
