...
import MessageContent from '@/components-V2/platform-views/apps/chat/chat-window/message-content'
...
import { getMessagePreview } from '@/components-V2/platform-utils/chat-utils'
