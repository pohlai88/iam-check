...
import { ResizableHandle, ResizablePanel, ResizablePanelGroup } from '@/components-V2/platform-components/ui/resizable'
import { Separator } from '@/components-V2/platform-components/ui/separator'
import { Sheet, SheetContent } from '@/components-V2/platform-components/ui/sheet'
...
// Config Imports
import { MAIL_COMPOSE_SESSION, MAIL_LABEL_NAV_ITEMS, MAIL_STATUS_NAV_ITEMS } from '@/components-V2/platform-config/mailConfig'

// Hook Imports
import { useMailApp } from '@/components-V2/platform-hooks/use-mail-app'
