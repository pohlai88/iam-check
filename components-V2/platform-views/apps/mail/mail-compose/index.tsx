...
// Type Imports
import type { ComposeEmailPayload } from '@/components-V2/platform-types/apps/mail-types'

// Component Imports
import { Button } from '@/components-V2/platform-components/ui/button'
import { Dialog, DialogContent, DialogTitle } from '@/components-V2/platform-components/ui/dialog'
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
// Config Imports
import { deriveRecipientEmailAddress } from '@/components-V2/platform-config/mailConfig'
