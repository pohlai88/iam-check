...
// SVG Imports
import FormWizardAccountSVG from '@/components-V2/platform-assets/svg/form-wizard-account'
import FormWizardPersonalInfoSVG from '@/components-V2/platform-assets/svg/form-wizard-personal-info'
import FormWizardAddressSVG from '@/components-V2/platform-assets/svg/form-wizard-address'
import FormWizardSocialLinkSVG from '@/components-V2/platform-assets/svg/form-wizard-social-link'
import FormWizardReviewSVG from '@/components-V2/platform-assets/svg/form-wizard-review'
