...
// Type Imports
import type { ComposeEmailPayload, Email, EmailLabel, EmailStatus, MailSortOrder } from '@/components-V2/platform-types/apps/mail-types'

// Store Imports
import { useMailStore } from '@/components-V2/platform-stores/use-mail-store'

// Config Imports
import { deriveRecipientEmailAddress, getEmailPreviewText, MAIL_CURRENT_USER } from '@/components-V2/platform-config/mailConfig'
