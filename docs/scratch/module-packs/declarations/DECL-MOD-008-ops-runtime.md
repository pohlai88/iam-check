...
Define the ops runtime authority for Declarations.
...
| --- | --- | --- | --- | --- |
| DECL-AC-008-01 | Enterprise Core | CORE-OPERATIONS | Core | TBD - replace before promotion |
