# DECL-MOD-006 Surfaces and Routes
...
Define the surfaces and routes authority for Declarations.
...
| --- | --- | --- | --- | --- |
| DECL-AC-006-01 | Enterprise Core | CORE-EXPERIENCE | Core | TBD - replace before promotion |
