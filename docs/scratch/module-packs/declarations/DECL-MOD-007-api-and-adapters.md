...
Define the api and adapters authority for Declarations.
...
| --- | --- | --- | --- | --- |
| DECL-AC-007-01 | Enterprise Core | CORE-INTEGRATION | Core | TBD - replace before promotion |
