    ...
    <CardContent className='col-span-5 flex flex-col gap-6 p-6 md:col-span-3'>
      <FieldGroup className='grid grid-cols-1 gap-6 sm:grid-cols-2'>
        <Field className='gap-2 md:max-lg:col-span-2'>
          <FieldLabel htmlFor='multi-step-deal-usage-user-type'>Target Audience</FieldLabel>
        ...
        <Field className='gap-2 md:max-lg:col-span-2'>
          <FieldLabel htmlFor='multi-step-deal-usage-payment-method'>Accepted Payments</FieldLabel>
        ...
        <Field className='gap-2 md:max-lg:col-span-2'>
          <FieldLabel htmlFor='multi-step-deal-usage-deal-status'>Product Status</FieldLabel>
