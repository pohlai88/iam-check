...
description: Read-only verifier for completed @afenda/payroll work. Checks architecture, calculations, security, tests, migrations, events, and finalization safety.
model: inherit
readonly: true
---
