...
import type {
	AccordionContentContract,
	AccordionContract,
	AccordionItemContract,
	AccordionTriggerContract,
} from "../../playground/types";

type AccordionProps = AccordionPrimitive.Root.Props & AccordionContract;
type AccordionItemProps = AccordionPrimitive.Item.Props & AccordionItemContract;
