...
export function EventCalendar({
	...
	const { currentDate, view, setView, goToPrevious, goToNext, goToToday } =
		useCalendarNavigation();
						...
						<div className="flex items-center gap-1 max-sm:justify-between sm:gap-4">
							<div className="flex items-center gap-1">
								<Sheet>
									...
									<SheetContent
										side="left"
										className="max-w-80! divide-y border-r"
									>
										<div className="p-4">
											<Button className="w-full" onClick={openNewEventDialog}>
												<PlusIcon size={16} aria-hidden="true" />
