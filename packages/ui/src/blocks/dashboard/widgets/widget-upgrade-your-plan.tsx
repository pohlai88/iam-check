...
const UpgradeYourPlanCard = ({ className }: { className?: string }) => {
	const { meta, getCardNumberProps, getCardImageProps, getCVCProps } =
		usePaymentInputs();
		...
		<Card className={cn("justify-between", className)}>
			<CardHeader>
				...
				<p className="text-muted-foreground text-sm">
					To fully enjoy all the amazing features and benefits of our premium
					plan.
				</p>
			</CardHeader>
			<CardContent>
						...
						<div className="flex items-center justify-between gap-2">
							<div className="flex items-center gap-2">
								<div className="bg-muted rounded-sm p-2">
									<img
										src="/images/widgets/master-card.webp"
										alt="master-card"
										className="w-8"
									/>
								</div>
