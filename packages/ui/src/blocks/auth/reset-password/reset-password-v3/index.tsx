				...
				<Card className="relative h-full justify-between overflow-hidden border-none py-8">
					...
					<CardHeader className="relative z-10 gap-6 px-8">
						<CardTitle className="text-4xl font-bold text-white xl:text-5xl/15.5">
							You&apos;re just one step away from regaining access to your
							account
						</CardTitle>
						<p className="text-xl text-white">
							Please create a new password below. Make sure it&apos;s strong and
							secure, combining letters, numbers, and special characters.
						</p>
					</CardHeader>
