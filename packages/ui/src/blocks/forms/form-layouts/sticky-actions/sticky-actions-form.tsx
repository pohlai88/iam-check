				...
				<div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
					<div className="space-y-8">
						...
						<FieldGroup className="grid grid-cols-1 gap-6 sm:grid-cols-2">
							...
							<Field className="gap-2">
								<FieldLabel htmlFor="alternateNumber">
									Alternate Number
								</FieldLabel>
								<Input
									id="alternateNumber"
							...
							<Field orientation="horizontal" className="col-span-full gap-2">
								<Checkbox
									...
									onCheckedChange={(checked) =>
										setUseAsDefault(checked as boolean)
									}
								/>
								<FieldLabel
							...
							{deliveryTypes.map((type, index) => (
								...
								>
									...
									<div className="grid grow justify-items-center gap-2">
										...
										<Label
											htmlFor={type.value}
											className="justify-center after:absolute after:inset-0"
										>
											{type.title}
										</Label>
										<p
						...
						<div className="mb-6 space-y-1">
							...
							<p className="text-muted-foreground text-sm">
								Enter your promo code to get discounts.
							</p>
						</div>
								...
								{promoCodes.map((promo, index) => (
									...
									>
										<div className="flex-1">
											<div
												className={`font-medium ${promo.disabled ? "text-muted-foreground" : ""}`}
											>
												{promo.code}
											</div>
