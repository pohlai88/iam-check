		...
		<form>
			...
			<FieldGroup className="gap-6">
				<Field className="grid grid-cols-1 gap-2 sm:grid-cols-6">
					<FieldLabel htmlFor="horizontal-form-separator-username">
						Username
					</FieldLabel>
					<Input
						id="horizontal-form-separator-username"
				...
				<Field className="grid grid-cols-1 gap-2 sm:grid-cols-6">
					<FieldLabel htmlFor="horizontal-form-separator-email">
						Email
					</FieldLabel>
					<InputGroup className="sm:col-span-5">
						<InputGroupInput
							id="horizontal-form-separator-email"
							placeholder="john.doe"
						/>
						<InputGroupAddon
							align="inline-end"
				...
				<Field className="grid grid-cols-1 gap-2 sm:grid-cols-6">
					<FieldLabel htmlFor="horizontal-form-separator-password">
						Password
					</FieldLabel>
					<InputGroup className="sm:col-span-5">
						<InputGroupInput
			...
			<FieldGroup className="gap-6">
				<Field className="grid grid-cols-1 gap-2 sm:grid-cols-6">
					<FieldLabel htmlFor="horizontal-form-separator-full-name">
						Full Name
					</FieldLabel>
					<Input
						id="horizontal-form-separator-full-name"
						className="sm:col-span-5"
						placeholder="John Doe"
					/>
				</Field>
				...
				<Field className="grid grid-cols-1 gap-2 sm:grid-cols-6">
					<FieldLabel htmlFor="horizontal-form-separator-country">
						Country
					</FieldLabel>
					<div className="sm:col-span-5">
						<Select items={countries}>
							<SelectTrigger
								id="horizontal-form-separator-country"
								className="w-full"
							>
								<SelectValue />
							</SelectTrigger>
				...
				<Field className="grid grid-cols-1 gap-2 sm:grid-cols-6">
					<FieldLabel htmlFor="horizontal-form-separator-birth-date">
						Birth Date
					</FieldLabel>
					<div className="sm:col-span-5">
				...
				<Field className="grid grid-cols-1 gap-2 sm:grid-cols-6">
					<FieldLabel htmlFor="horizontal-form-separator-phone">
						Phone No
					</FieldLabel>
					<Input
						id="horizontal-form-separator-phone"
						className="sm:col-span-5"
						type="tel"
