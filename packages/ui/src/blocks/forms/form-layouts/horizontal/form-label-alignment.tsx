		...
		<form>
			...
			<FieldGroup className="gap-6">
				<Field className="grid grid-cols-1 gap-2 sm:grid-cols-6">
					<FieldLabel
						htmlFor="horizontal-form-label-alignment-username"
						className="sm:justify-end"
					>
						Username
					</FieldLabel>
					<Input
						id="horizontal-form-label-alignment-username"
				...
				<Field className="grid grid-cols-1 gap-2 sm:grid-cols-6">
					<FieldLabel
						htmlFor="horizontal-form-label-alignment-email"
						className="sm:justify-end"
					>
						Email
					</FieldLabel>
					<InputGroup className="sm:col-span-5">
						<InputGroupInput
							id="horizontal-form-label-alignment-email"
							placeholder="john.doe"
						/>
						<InputGroupAddon
							align="inline-end"
				...
				<Field className="grid grid-cols-1 gap-2 sm:grid-cols-6">
					<FieldLabel
						htmlFor="horizontal-form-label-alignment-password"
						className="sm:justify-end"
					>
						Password
					</FieldLabel>
			...
			<FieldGroup className="gap-6">
				<Field className="grid grid-cols-1 gap-2 sm:grid-cols-6">
					<FieldLabel
						htmlFor="horizontal-form-label-alignment-full-name"
						className="sm:justify-end"
					>
						Full Name
					</FieldLabel>
					<Input
						id="horizontal-form-label-alignment-full-name"
						className="sm:col-span-5"
						placeholder="John Doe"
					/>
				</Field>
				...
				<Field className="grid grid-cols-1 gap-2 sm:grid-cols-6">
					<FieldLabel
						htmlFor="horizontal-form-label-alignment-country"
						className="sm:justify-end"
					>
						Country
					</FieldLabel>
					<div className="sm:col-span-5">
						<Select items={countries}>
							<SelectTrigger
								id="horizontal-form-label-alignment-country"
								className="w-full"
							>
								<SelectValue />
							</SelectTrigger>
				...
				<Field className="grid grid-cols-1 gap-2 sm:grid-cols-6">
					<FieldLabel
						htmlFor="horizontal-form-label-alignment-birth-date"
						className="sm:justify-end"
					>
						Birth Date
					</FieldLabel>
				...
				<Field className="grid grid-cols-1 gap-2 sm:grid-cols-6">
					<FieldLabel
						htmlFor="horizontal-form-label-alignment-phone"
						className="sm:justify-end"
					>
						Phone No
					</FieldLabel>
