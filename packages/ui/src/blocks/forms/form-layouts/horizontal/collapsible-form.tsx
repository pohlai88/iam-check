...
const CollapsibleForm = () => {
	...
	return (
		<Accordion
			...
			className="space-y-4 overflow-visible border-0"
		>
			<AccordionItem
				...
				<AccordionContent className="border-t px-6 pt-6 pb-6">
					<FieldGroup className="gap-6">
						<Field className="grid grid-cols-1 gap-2 sm:grid-cols-6">
							<FieldLabel htmlFor="horizontal-collapsible-fullName">
								Full Name
							</FieldLabel>
							<Input
								id="horizontal-collapsible-fullName"
						...
						<Field className="grid grid-cols-1 gap-2 sm:grid-cols-6">
							<FieldLabel htmlFor="horizontal-collapsible-phoneNo">
								Phone No.
							</FieldLabel>
							<Input
						...
						<Field className="grid grid-cols-1 items-start gap-2 sm:grid-cols-6">
							<FieldLabel htmlFor="horizontal-collapsible-address">
								Address
							</FieldLabel>
							<Textarea
						...
						<Field className="grid grid-cols-1 gap-2 sm:grid-cols-6">
							<FieldLabel htmlFor="horizontal-collapsible-pincode">
								Pincode
							</FieldLabel>
							<Input
								id="horizontal-collapsible-pincode"
								className="sm:col-span-5"
								placeholder="123456"
							/>
						</Field>
						...
						<Field className="grid grid-cols-1 gap-2 sm:grid-cols-6">
							<FieldLabel htmlFor="horizontal-collapsible-landmark">
								Landmark
							</FieldLabel>
							<Input
								id="horizontal-collapsible-landmark"
								className="sm:col-span-5"
						...
						<Field className="grid grid-cols-1 gap-2 sm:grid-cols-6">
							<FieldLabel htmlFor="horizontal-collapsible-city">
								City
							</FieldLabel>
							<Input
								id="horizontal-collapsible-city"
								className="sm:col-span-5"
						...
						<Field className="grid grid-cols-1 gap-2 sm:grid-cols-6">
							<FieldLabel htmlFor="horizontal-collapsible-state">
								State
							</FieldLabel>
							<div className="sm:col-span-5">
								<Select items={states}>
									<SelectTrigger
										id="horizontal-collapsible-state"
										className="w-full"
									>
										<SelectValue />
									</SelectTrigger>
						...
						<Field className="grid grid-cols-1 items-start gap-2 sm:grid-cols-6">
							...
							>
								...
								>
									<RadioGroupItem
										value="home"
										id="horizontal-collapsible-home"
									/>
									<FieldLabel
										htmlFor="horizontal-collapsible-home"
								...
								>
									<RadioGroupItem
										value="office"
										id="horizontal-collapsible-office"
									/>
									<FieldLabel
										htmlFor="horizontal-collapsible-office"
										className="font-normal"
									>
					...
					<form>
						<FieldGroup className="gap-6">
							<Field className="grid grid-cols-1 items-start gap-2 sm:grid-cols-6">
								...
								>
									...
									>
										<RadioGroupItem
											value="card"
											id="horizontal-collapsible-card"
										/>
										<FieldLabel
											htmlFor="horizontal-collapsible-card"
									...
									>
										<RadioGroupItem
											value="cod"
											id="horizontal-collapsible-cod"
										/>
										<FieldLabel
											htmlFor="horizontal-collapsible-cod"
											className="flex items-center gap-1.5 font-normal"
										>
							...
							{selectedPayment === "card" && (
								<>
									<Field className="grid grid-cols-1 gap-2 sm:grid-cols-6">
										<FieldLabel htmlFor="horizontal-collapsible-cardNumber">
											Card Number
										</FieldLabel>
										<Input
									...
									<Field className="grid grid-cols-1 gap-2 sm:grid-cols-6">
										<FieldLabel htmlFor="horizontal-collapsible-cardName">
											Name
										</FieldLabel>
										<Input
											id="horizontal-collapsible-cardName"
											className="sm:col-span-5"
											placeholder="John Doe"
										/>
									</Field>
									...
									<Field className="grid grid-cols-1 gap-2 sm:grid-cols-6">
										<FieldLabel htmlFor="horizontal-collapsible-expiryDate">
											Expiry Date
										</FieldLabel>
										<Input
											id="horizontal-collapsible-expiryDate"
											className="sm:col-span-5"
											placeholder="MM/YY"
										/>
									</Field>
									...
									<Field className="grid grid-cols-1 gap-2 sm:grid-cols-6">
										<FieldLabel htmlFor="horizontal-collapsible-cvv">
											CVV Code
										</FieldLabel>
										<Input
											id="horizontal-collapsible-cvv"
											className="sm:col-span-5"
											placeholder="123"
											maxLength={3}
										/>
							...
							{selectedPayment === "cod" && (
								<Field className="grid grid-cols-1 gap-2 sm:grid-cols-6">
									...
									<p className="text-muted-foreground text-sm sm:col-span-5">
										...
										recipient makes payment at the time of delivery rather than
										in advance.
									</p>
								</Field>
							)}
