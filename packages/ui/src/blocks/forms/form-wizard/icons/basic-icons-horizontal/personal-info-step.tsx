		...
		<div className="flex flex-col gap-6">
			...
			<div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
				<div className="flex flex-col items-start gap-2">
					<Label
						htmlFor="multi-step-personal-info-first-name"
						className="leading-5"
					>
						First Name
					</Label>
				...
				<div className="flex flex-col items-start gap-2">
					<Label
						htmlFor="multi-step-personal-info-last-name"
						className="leading-5"
					>
						Last Name
					</Label>
				...
				<div className="flex flex-col items-start gap-2">
					<Label
						htmlFor="multi-step-personal-info-mobile"
						className="leading-5"
					>
						Mobile
					</Label>
				...
				<div className="flex flex-col items-start gap-2">
					<Label
						htmlFor="multi-step-personal-info-pincode"
						className="leading-5"
					>
						Pincode
					</Label>
				...
				<div className="flex flex-col items-start gap-2 sm:col-span-2">
					<Label
						htmlFor="multi-step-personal-info-address"
						className="leading-5"
					>
						Address
					</Label>
					<Input
						id="multi-step-personal-info-address"
						placeholder="123 Main St"
					/>
				</div>
				<div className="flex flex-col items-start gap-2 sm:col-span-2">
					<Label
						htmlFor="multi-step-personal-info-landmark"
						className="leading-5"
					>
						Landmark
					</Label>
