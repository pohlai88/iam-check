		...
		<CardContent className="col-span-5 flex flex-col gap-6 p-6 md:col-span-3">
			<FieldGroup className="grid grid-cols-1 gap-6 sm:grid-cols-2">
				<Field className="gap-2 md:max-lg:col-span-2">
					<FieldLabel htmlFor="multi-step-product-pricing-user-type">
						Target Audience
					</FieldLabel>
					<Select items={targetAudienceItems}>
						<SelectTrigger
							id="multi-step-product-pricing-user-type"
							className="w-full"
						>
							<SelectValue />
						</SelectTrigger>
				...
				<Field className="gap-2 md:max-lg:col-span-2">
					<FieldLabel htmlFor="multi-step-product-pricing-payment-method">
						Accepted Payments
					</FieldLabel>
					<Select items={paymentMethodItems}>
						<SelectTrigger
							id="multi-step-product-pricing-payment-method"
							className="w-full"
						>
							<SelectValue />
						</SelectTrigger>
				...
				<Field className="gap-2 md:max-lg:col-span-2">
					<FieldLabel htmlFor="multi-step-product-pricing-product-status">
						Product Status
					</FieldLabel>
					<Select items={productStatusItems}>
						<SelectTrigger
							id="multi-step-product-pricing-product-status"
							className="w-full"
						>
							<SelectValue />
						</SelectTrigger>
				...
				<Field orientation="horizontal" className="sm:col-span-2">
					...
					<FieldLabel htmlFor="limit-single-use">
						Limit purchase to one per customer
					</FieldLabel>
				</Field>
			</FieldGroup>
