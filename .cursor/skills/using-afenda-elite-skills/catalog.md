...
| `afenda-elite-monorepo-discipline` | local-elite-farm | local | keep | Day-to-day `@afenda/*` import/DAG/export surface | Cross-package imports · new `packages/*` · layer violations · Rank-1 http/security/metrics/audit/search/notifications/events/ai-the-machine | ARCH-024 · ARCH-022 · docs-V2/monorepo · docs-V2/ai · docs-V2/events | none | `.cursor/skills/afenda-elite-monorepo-discipline/SKILL.md` · [LAYERS.md](../afenda-elite-monorepo-discipline/LAYERS.md) | Lite rewrite of Xerp `monorepo-discipline` (no Xerp LOAD); AI DNA under docs-V2/ai |
