...
| Retired | Replacement | Status | Notes |
|---------|-------------|--------|-------|
| `@afenda/ui` package (`packages/design-system`, **base-vega**) | `@afenda/ui-system` (`packages/surfaces/ui-system`, shadcn **new-york** / Radix) | Hard-deleted | ADR-010 cutover 2026-07-16; do not restore `packages/design-system` or the `@afenda/ui` name. Owned regenerable shadcn source; no external/paid registries. |
