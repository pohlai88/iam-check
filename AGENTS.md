...
| Next open (Neon Auth `N*`) | **N15** APPROVED at 97%; Path-to-100% open. Next ID = **N16** only — do **not** sneak-start here. Map: [neon-auth-slice-map](.cursor/skills/afenda-elite-implementation-slices/neon-auth-slice-map.md). |
